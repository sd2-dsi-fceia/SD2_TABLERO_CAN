...
- name: BOARD_InitPeripherals
  UUID: 32d48860-dfc7-4ec6-af14-fef78c4d4df2
  called_from_default_init: true
  selectedCore: core0
- name: BOARD_InitButtonsPeripheral
  UUID: 899af9dd-3016-4d3e-aed5-51742657144f
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitLEDsPeripheral
  UUID: ce3da706-dcee-462c-a155-d1dcabdeedc0
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitACCELPeripheral
  UUID: c08423ae-3315-4bd2-8361-45c1d47364ae
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitMAGPeripheral
  UUID: ff70f71a-b1b6-4909-a365-c9a3e678d29d
  selectedCore: core0
- name: BOARD_InitDEBUG_UARTPeripheral
  UUID: 1f6e650d-1f1e-4139-9b37-e7154f88e8c6
  id_prefix: BOARD_
  selectedCore: core0
