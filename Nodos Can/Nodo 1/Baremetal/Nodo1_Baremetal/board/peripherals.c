...
- name: BOARD_InitPeripherals
  UUID: 2787d0d3-490b-4de2-b6bb-fafba1228e94
  called_from_default_init: true
  selectedCore: core0
- name: BOARD_InitButtonsPeripheral
  UUID: 087c5fc1-45db-4295-867e-adb7c8a0904b
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitLEDsPeripheral
  UUID: d280e04c-48ae-4b69-a585-e8c92b8cf677
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitACCELPeripheral
  UUID: 776e7025-aa85-43ce-95c0-60c1bf1b6338
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitMAGPeripheral
  UUID: 05b9d870-6f17-43a7-af88-795a5a83017c
  selectedCore: core0
- name: BOARD_InitDEBUG_UARTPeripheral
  UUID: 0687d12b-ac12-4551-b6f4-9ff7812a1e1b
  id_prefix: BOARD_
  selectedCore: core0
