...
/*! @name PORTA17 (number 47), J2[15]
  @{ */

/* Symbols to be used with GPIO driver */
#define BOARD_INTERRUPT_FGPIO FGPIOA              /*!<@brief FGPIO peripheral base pointer */
#define BOARD_INTERRUPT_GPIO GPIOA                /*!<@brief GPIO peripheral base pointer */
#define BOARD_INTERRUPT_GPIO_PIN_MASK (1U << 17U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_INTERRUPT_PORT PORTA                /*!<@brief PORT peripheral base pointer */
#define BOARD_INTERRUPT_PIN 17U                   /*!<@brief PORT pin number */
#define BOARD_INTERRUPT_PIN_MASK (1U << 17U)      /*!<@brief PORT pin mask */
                                                  /* @} */
