...
- name: BOARD_InitPeripherals
  UUID: bc1b8f92-0c7b-48c9-9d25-63a4760b9a61
  called_from_default_init: true
  selectedCore: core0
- name: BOARD_InitButtonsPeripheral
  UUID: 3ccf29ba-2282-4694-bcc7-f51453d5bb39
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitLEDsPeripheral
  UUID: 6e7d1127-b186-4998-b877-a47f6bf5d15f
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitACCELPeripheral
  UUID: 7dd1f952-d116-4e1b-a727-271ccdb85886
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitMAGPeripheral
  UUID: 675d9399-89b7-40f1-964b-cdf92b67419b
  selectedCore: core0
- name: BOARD_InitDEBUG_UARTPeripheral
  UUID: 1086a954-ae8a-4649-9cd7-aef5e455e907
  id_prefix: BOARD_
  selectedCore: core0
