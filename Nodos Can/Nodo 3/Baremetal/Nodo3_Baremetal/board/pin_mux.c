...
- {pin_num: '47', pin_signal: PTA17/SPI0_MISO/SPI0_MOSI/I2S0_MCLK, label: 'J2[15]', identifier: INTERRUPT}
...
void BOARD_InitPins(void)
{
    ...
    GPIO_PinInit(BOARD_INTERRUPT_GPIO, BOARD_INTERRUPT_PIN, &INTERRUPT_config);

    /* PORTA17 (pin 47) is configured as PTA17 */
    PORT_SetPinMux(BOARD_INTERRUPT_PORT, BOARD_INTERRUPT_PIN, kPORT_MuxAsGpio);

    /* Interrupt configuration on PORTA17 (pin 47): Interrupt when logic zero */
    PORT_SetPinInterruptConfig(BOARD_INTERRUPT_PORT, BOARD_INTERRUPT_PIN, kPORT_InterruptLogicZero);
