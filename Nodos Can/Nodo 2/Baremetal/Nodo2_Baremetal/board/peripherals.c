...
- name: BOARD_InitPeripherals
  UUID: 7af6594a-6cc3-4ef2-a85a-b392937755a7
  called_from_default_init: true
  selectedCore: core0
- name: BOARD_InitButtonsPeripheral
  UUID: 895e9c49-be53-4bb1-b525-cb3f1e340b94
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitLEDsPeripheral
  UUID: af15587b-5a7d-4d86-b99a-d91234c8306c
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitACCELPeripheral
  UUID: b41baf20-b302-40c0-a79c-df1fd033324c
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitMAGPeripheral
  UUID: 8e1685f4-0e0b-4a4e-9004-5a4bd74c2fc8
  selectedCore: core0
- name: BOARD_InitDEBUG_UARTPeripheral
  UUID: 63a12a57-79af-4a59-a59b-60ad707a0c17
  id_prefix: BOARD_
  selectedCore: core0
