...
/*! @name PORTE22 (number 20), J4[5]/SNS_LIGHT_ADC/DIFF_ADC1_DP
  @{ */

/* Symbols to be used with PORT driver */
#define BOARD_ADC_LIGHT_SNS_PORT PORTE                /*!<@brief PORT peripheral base pointer */
#define BOARD_ADC_LIGHT_SNS_PIN 22U                   /*!<@brief PORT pin number */
