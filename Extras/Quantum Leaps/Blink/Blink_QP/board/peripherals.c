...
- name: BOARD_InitPeripherals
  UUID: 8719b092-62c1-402c-8fb4-b297c1f8142f
  called_from_default_init: true
  selectedCore: core0
- name: BOARD_InitButtonsPeripheral
  UUID: 4164d00c-cced-4b53-99be-fe934d9436d0
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitLEDsPeripheral
  UUID: f8e9bb27-ccd5-4bd1-aae1-9750089f675a
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitACCELPeripheral
  UUID: a5dd3ce6-1b12-4aa0-86ad-0f52b0907c1f
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitMAGPeripheral
  UUID: a6248319-4f8a-4427-a587-653f189c86cf
  selectedCore: core0
- name: BOARD_InitDEBUG_UARTPeripheral
  UUID: 785596f9-7555-4ebd-8b83-c7f0740ad49c
  id_prefix: BOARD_
  selectedCore: core0
